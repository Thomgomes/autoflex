...
describe('AppSidebar Component', () => {
  it('should render the sidebar with brand title', () => {
    ...
    // Verifica o título e o subtítulo do projeto
  ...
  it('should render all navigation items correctly', () => {
    ...
    // Verifica se os itens do menu estão lá
  ...
  it('should have correct links for each nav item', () => {
    ...
    // Usa os data-testid que você inteligentemente colocou no código
    expect(screen.getByTestId('nav-dashboard')).toHaveAttribute('href', '/');
    expect(screen.getByTestId('nav-materiais')).toHaveAttribute('href', '/materials');
    expect(screen.getByTestId('nav-produtos')).toHaveAttribute('href', '/products');
  });
});